$(function(){
  ...
  function elimina_material(id_material){

    console.log('Eliminar el ladrillo: '+id_material);

    var confirma = confirm("En realidad quiere quitar este elemento?");
    ...
    if(confirma == true){
      ...
      $.ajax({
            url: '../controller/ajaxController.php',
            data: "id_material="+id_material+"&tipo=elimina_material",
        })
        .done(function(data) {            
            //---------------------
            console.log(data[0].mensaje);
