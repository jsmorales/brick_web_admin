	...
	class indexController extends indexDAO{
		...
		function box_saludo1(){
			...
			echo '<div class="col-lg-12">
                    ...
                    <p>Esta página pretende dar a nuestros clientes la facilidad de hacer sus <a href="#">cotizaciones</a> en línea, para que a la hora de acercarse a hacer su compra sea más rápido y efectivo su proceso de construcción o ejecución de su proyecto. Infórmese acerca de nuestros materiales en la sección de <a href="#">catálogo</a>, para que tenga presente a la hora de hacer la cotización todas las características de los productos, tales como el precio entre otros.</p>
                    <p>Recuerde que en nuestra sección de <a href="contacto.php">contacto</a> podrá recibir respuesta a todas sus inquietudes y sugerencias o si tiene algún tipo de petición especial.</p>
                </div>';
		}
